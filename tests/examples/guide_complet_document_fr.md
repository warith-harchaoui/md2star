...
En utilisant Mermaid CLI, nous pouvons intégrer en toute sécurité des diagrammes d’architecture système directement dans les documents sans casser Pandoc:
