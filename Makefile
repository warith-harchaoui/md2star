...
#
# Copies Lua filters, YAML defaults, templates, metadata, preprocessing.py,
# and the gup utility. Installs CLI wrappers (md2docx, md2pptx, gup).
...
#
# Deletes filters, defaults, templates, metadata, gup, and CLI wrappers
